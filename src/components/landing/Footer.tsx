        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Plataforma integral para gestión de envíos y logística de última milla.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-muted-foreground">
                ...
                <a href="mailto:soporte@tuapp.com" className="hover:text-foreground transition-colors">
                  soporte@tuapp.com
                </a>
              </li>
              <li className="flex items-center gap-2 text-muted-foreground">
