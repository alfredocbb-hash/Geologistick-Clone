      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="p-8 rounded-2xl bg-card dark:bg-white/[0.02] border border-border dark:border-white/5 hover:border-[hsl(var(--geo-teal)/0.3)] transition-all duration-300 group">
            ...
            <h3 className="text-xl font-semibold text-foreground dark:text-white mb-3">Quiénes somos</h3>
          ...
          <div className="p-8 rounded-2xl bg-card dark:bg-white/[0.02] border border-border dark:border-white/5 hover:border-[hsl(var(--geo-teal)/0.3)] transition-all duration-300 group">
            ...
            <h3 className="text-xl font-semibold text-foreground dark:text-white mb-3">Nuestra misión</h3>
            <p className="text-muted-foreground dark:text-gray-400 leading-relaxed">
              {about.mission}
            </p>
          </div>
          ...
          <div className="p-8 rounded-2xl bg-card dark:bg-white/[0.02] border border-border dark:border-white/5 hover:border-[hsl(var(--geo-teal)/0.3)] transition-all duration-300 group">
            ...
            <h3 className="text-xl font-semibold text-foreground dark:text-white mb-3">Nuestra visión</h3>
            <p className="text-muted-foreground dark:text-gray-400 leading-relaxed">
              {about.vision}
            </p>
          </div>
