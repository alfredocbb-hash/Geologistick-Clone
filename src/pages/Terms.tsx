...
const Terms = () => {
  return (
    ...
    <LegalPageLayout title="Términos de Servicio" lastUpdated="27 de enero de 2026">
      ...
      <section>
        <h2 className="text-xl font-semibold text-white mb-4">5. Tarifas y Pagos</h2>
        <p className="text-gray-400 leading-relaxed">
      ...
      <section>
        <h2 className="text-xl font-semibold text-white mb-4">6. Responsabilidad por Envíos</h2>
        <Card className="bg-white/[0.02] border-white/10 backdrop-blur-sm">
          <CardContent className="pt-6">
            <p className="text-gray-400 leading-relaxed mb-4">
              <strong className="text-white">El remitente es responsable de:</strong>
            </p>
            ...
            <p className="text-gray-400 leading-relaxed">
              <strong className="text-white">Geologistick no se responsabiliza por:</strong> 
      ...
      <section>
        <h2 className="text-xl font-semibold text-white mb-4">8. Propiedad Intelectual</h2>
        <p className="text-gray-400 leading-relaxed">
      ...
      <section>
        <h2 className="text-xl font-semibold text-white mb-4">10. Modificaciones</h2>
        <p className="text-gray-400 leading-relaxed">
